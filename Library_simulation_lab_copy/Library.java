...
public final class Library {
    ...
    private LibrarySlave slave;

    public Library() {
        items = new ArrayList<>();
        slave = new LibrarySlave();
    }
    ...
    public void borrowItem(String id, User borrower, LocalDate borrowDate) {
        slave.borrowItem(id, borrower, borrowDate);
    }
    ...
    public void showStatistics(LocalDate today) {
        slave.showStatistics(today);
    }

    private class LibrarySlave {
        public LibrarySlave() {
        items = new ArrayList<>();
        }
